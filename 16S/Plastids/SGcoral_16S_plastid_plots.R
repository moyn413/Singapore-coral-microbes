...
ps.noncontam_noeuk_noC <-  ps.noncontam %>% subset_samples(Sample_or_Control != "Control")  %>% subset_samples(NucleicType != "decontam") 

# Remove OTUs occurring fewer than 10x (Low read samples were already removed in 16S non-plastid processing)
